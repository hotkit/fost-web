        ...
        std::pair<boost::shared_ptr<fostlib::mime>, int> operator () (
            ...
            if ( !config.has_key("location") )
                throw fostlib::exceptions::not_implemented(
                    "Configuration 'location' must give a full URL to redirect to");
            ...
            boost::shared_ptr<fostlib::mime> response(
                    new fostlib::text_body(
                        L"<html><head><title>Moved Permanently</title></head>"
                            L"<body><h1>Moved Permanently</h1></body></html>",
                        headers, L"text/html" ));
            return std::make_pair(response, 301);
        }
} c_response_301;

const fostlib::urlhandler::view &fostlib::urlhandler::response_301 =c_response_301;
